	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                ...
	                                <p class="category">Artikel yang Berhubungan dengan Cabai</p>
	                            </div>
	                            <div class="col-md-12">
                            <div class="card">
								<?php foreach($post as $u){ ?>
                                <form action="<?php echo base_url().'index.php/berita/update'; ?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="card-content">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty" style="margin: 15px 0 0 0">
                                                    ...
                                                    <span class="help-block">Silahkan isi judul artikel</span>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty" style="margin: 15px 0 0 0">
                                                    <label class="control-label"></label>
                                                    <textarea class="form-control" rows="10" name="isi"><?php echo $u->isi ?></textarea>
													<span class="help-block">Silahkan isi judul artikel</span>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="form-group label-floating is-empty" style="margin: 15px 0 0 0">
                                                    <label class="control-label"></label>
                                                    <input type="text" name="kategori" class="form-control" value="<?php echo $u->kategori ?>">
													<span class="help-block">Silahkan isi kategori</span>
                                                <span class="material-input"></span></div>
                                            </div>
                                        </div>
										<div class='clearfix'>
