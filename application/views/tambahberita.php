                    ...
                    <div class="row">
	                    <div class="col-md-12">
	                        <div class="card">
	                            ...
	                            <div class="col-md-12">
                            <div class="card">								
                                <form action="<?php echo base_url().'index.php/berita/tambah_baru'; ?>" method="post" class="form-horizontal">
                                    ...
                                    <div class="card-content">
										...
										<div class='clearfix'>
											<div class='pull-right'>
												...
												<input type="submit" value="Tambah" class="btn btn-primary btn-fill">
											</div>
										</div>
                                    </div>
                                </form>
