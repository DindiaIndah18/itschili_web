                 ...
                 <div class="col-md-6">
                       <div class="card">
                           ...
                           <div class="card-content">
                               <h4 class="card-title">Edit Lokasi Pasar</h4>
                               <form method="post" action="<?php echo base_url('index.php/itschilli/menuEditLokasi/'.$datalokasi->id_pasar); ?>">

                                 <div class="form-group label-floating">
                                     <label class="control-label">Id Pasar</label>
                                     <input type="text" class="form-control" disabled="" value="<?php echo $datalokasi->id_pasar; ?>">
                                 </div>
                                 <div class="form-group label-floating">
                                     <label class="control-label">Nama Pasar</label>
                                     <input type="text" class="form-control" value="<?php echo $datalokasi->nama_pasar; ?>" name="nama_pasar">
                                 </div>
                                 <div class="form-group label-floating">
                                     <label class="control-label">Nama Lokasi</label>
                                     <input type="text" class="form-control" value="<?php echo $datalokasi->nama_lokasi; ?>" name="nama_lokasi">
                                 </div>
