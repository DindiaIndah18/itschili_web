	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">List Artikel</h4>
...
<td>
<?php echo anchor('berita/edit/'.$u->id_post,'Edit'); ?>
	<?php echo anchor('berita/hapus/'.$u->id_post,'Hapus'); ?>
</td>
</tr>
<?php } ?>
	                                    </tbody>
	        ...
	        <footer class="footer">
	            <div class="container-fluid">
	                ...
	                <p class="copyright pull-right">
	                    &copy; <script>document.write(new Date().getFullYear())</script> ITS CHILI </a>, made with love for a better web
	                </p>
	            </div>
	        </footer>
	    </div>
